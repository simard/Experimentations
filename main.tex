	...
	\chapter{Recherche d'une structure}
		\section{Protocole}
			\subsection{Scénario}
				...
				Afin de pouvoir faire ce choix d'association main/outil, une phase d'apprentissage (sur \Nom{trp-cage}) et de découverte des outils laissera une totale liberté pour la manipulation.
